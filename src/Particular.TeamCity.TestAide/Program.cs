...
namespace Particular.TeamCity.TestAide
{
    ...
    class Program
    {
                ...
                foreach (var testingDir in testingDirs)
                {
                    ...
                    if (targetDirectories.Any())
                    {
                        ...
                        foreach (var targetDirectory in targetDirectories)
                        {
                            ...
                            var restoreExitCode = UpdateUnixDependencies(doUnixDependencies.ParsedValue, targetDirectory, dirInfo, targetName);
                            if (exitCode == 0)
                            {
        ...
        static int UpdateUnixDependencies(string doUnixDependencies, string targetDirectory, DirectoryInfo projectDirectoryInfo, string targetName)
        {
